...
class Manager():
    ...
    def _evaluate(self, first=False, log=True, trackers_folder=None):
        names = list()
        ...
        if 'bdd' in self.dataset_cfg['mot_dir']:
            ...
            _, _ = self.eval_track_eval(log, trackers_folder=trackers_folder)
    ...
    def eval_track_eval(self, log=True, dir='val', trackers_folder=None):
