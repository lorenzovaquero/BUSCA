...
try:
    _SPLITS['bdd100k_val']['test'] = {'seq': os.listdir('datasets/BDD100/bdd100k/images/track/val'), 'dir': 'val'}
    _SPLITS['bdd100k_test']['test'] = {'seq': os.listdir('datasets/BDD100/bdd100k/images/track/test'), 'dir': 'test'}
except FileNotFoundError as e:
    print('BDD100k not found, skipping ({})'.format(e))
    _SPLITS['bdd100k_val']['test'] = {'seq': [], 'dir': 'val'}
    _SPLITS['bdd100k_test']['test'] = {'seq': [], 'dir': 'test'}
...
try:
    _SPLITS['dance_test']['test'] = {'seq': os.listdir('datasets/DanceTrack/test'), 'dir': 'test'}
    _SPLITS['dance_val']['test'] = {'seq': os.listdir('datasets/DanceTrack/val'), 'dir': 'val'}
except FileNotFoundError as e:
    print('DanceTrack not found, skipping ({})'.format(e))
    _SPLITS['dance_test']['test'] = {'seq': [], 'dir': 'val'}
    _SPLITS['dance_val']['test'] = {'seq': [], 'dir': 'test'}
