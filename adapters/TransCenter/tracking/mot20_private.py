...
def get_args_parser():
    ...
    parser.add_argument('--data_dir', default='/YourPathTo/MOT20/', type=str)
    ...
    parser.add_argument('--pretrained', type=str,
                        default=os.path.join(os.path.dirname(__file__), '..', 'model_zoo', 'pvtv2_backbone', 'pvt_v2_b2.pth'),
                        help="pretrained")
...
def main(tracktor):
    ...
    # tracker
    tracker = Tracker(model, None, liteFlowNet, tracktor['tracker'], postprocessor=postprocessors['bbox'], main_args=main_args)
